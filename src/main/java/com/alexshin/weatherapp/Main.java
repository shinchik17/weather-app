...
//        WeatherApiResponseDTO resp = objectMapper.readValue(multipleWeathersResponse, WeatherApiResponseDTO.class);
        var resp = service.getWeatherByLocationName("London");
        var resp2 = service.getWeatherByLocationCoords(resp.getCoord().getLat(), resp.getCoord().getLon());
        var resp3 = service.searchLocationByName("London");
